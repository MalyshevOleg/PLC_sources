...
off_images="bc ba l1 ub kern rfs ufs"
...
cat >> $script_src_file << END
	${cond}if fatload mmc 0 \$off_loadaddr \${off_subdir}$f; then
		off_dl_ok=1
END
cond="el"
done
...
kern=50000
setenv kern 50000
ethaddr=6a:77:00:22:03:5d
setenv ethaddr 6a:77:00:22:03:5d
setenv ipaddr 10.0.6.10
setenv serverip 10.0.6.1
setenv netmask 255.255.0.0
setenv gatewayip 10.0.6.1
fileaddr=81600000
